	...
	$.fn.extend({ 
		...
		var options = $.extend(defaults, options);
			...
			if(o.showControls)
			{
				...
				html = '<div id="play_pause_btn'+randID+'" style="cursor:pointer;position:absolute;top:285px;right:3px;border:none;width:16px;height:16px;background:url('+o.imagePath+'playpause.gif) no-repeat 0 0"></div>';
				$(obj).append(html);
				var status = 'play';
